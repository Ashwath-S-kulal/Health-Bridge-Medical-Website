...
export default function NearbyFacility() {
  return (
    <div className="flex min-h-screen bg-[#F8FAFC]">
      ...
      {/* Main Content Area - Responsive margin handling */}
      <main className="flex-1 w-full lg:ml-64 p-4 sm:p-6 md:p-8 transition-all duration-300">
        ...
        {/* Navigation Cards Grid - Responsive columns */}
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 md:gap-8 mb-8 md:mb-12">
          
          {/* Card 1: Hospitals */}
          <NavLink to="/hospital" className="group">
            <div className="h-full bg-white p-6 md:p-8 rounded-[30px] md:rounded-[40px] shadow-sm border border-slate-100 hover:shadow-xl transition-all duration-500 hover:-translate-y-1 relative overflow-hidden">
              ...
              <div className="relative z-10">
                <div className="w-12 h-12 md:w-14 md:h-14 bg-cyan-500 text-white rounded-xl md:rounded-2xl flex items-center justify-center mb-4 md:mb-6 shadow-lg shadow-cyan-200 group-hover:scale-110 transition-transform">
          ...
          {/* Card 2: Pharmacies/Medical Stores */}
          <NavLink to="/medical" className="group">
            <div className="h-full bg-white p-6 md:p-8 rounded-[30px] md:rounded-[40px] shadow-sm border border-slate-100 hover:shadow-xl transition-all duration-500 hover:-translate-y-1 relative overflow-hidden">
              ...
              <div className="relative z-10">
                <div className="w-12 h-12 md:w-14 md:h-14 bg-[#F43F5E] text-white rounded-xl md:rounded-2xl flex items-center justify-center mb-4 md:mb-6 shadow-lg shadow-rose-200 group-hover:scale-110 transition-transform">
        ...
        {/* Quick Search Section - Stacked on mobile, row on desktop */}
        <div className="bg-[#0F172A] rounded-[24px] md:rounded-[32px] p-6 md:p-8 text-white flex flex-col md:flex-row items-center justify-between gap-6 shadow-2xl shadow-slate-200">
          ...
          <button className="w-full md:w-auto bg-cyan-500 hover:bg-cyan-400 text-white px-6 md:px-8 py-3 md:py-4 rounded-xl md:rounded-2xl font-black text-[10px] md:text-xs uppercase tracking-widest transition-all active:scale-95 flex items-center justify-center gap-2">
