      ...
      <div className="flex min-h-screen bg-[#F1F5F9] p-4 md:p-8 lg:p-12">
        <div className="max-w-6xl w-full mx-auto space-y-6">
          ...
          <div className="flex justify-between items-center bg-white p-6 rounded-3xl shadow-sm border border-slate-200">
            <h1 className="font-bold text-slate-800 text-xl tracking-tight">Account Center</h1>
            <div className="flex gap-2">
              {currentUser?.isAdmin && (
                <NavLink to="/profile/adminpanel" className="px-4 py-2 text-xs font-bold text-slate-600 hover:bg-slate-50 rounded-xl transition-all border border-slate-100">
                  Admin Panel
                </NavLink>
              )}
          ...
          {/* Main Grid: Left and Right Cards */}
