  ...
  return (
    <div>
      ...
      <div className="flex min-h-screen bg-[#f8fafc]">
        ...
        <div className="flex-1 w-full   4 transition-all duration-300">
              ...
              <div className="flex flex-wrap items-center gap-4">
                <div className="flex items-center gap-6 bg-white border border-slate-200 p-4 rounded-2xl shadow-sm grow sm:grow-0">
                  ...
                  <div className="flex flex-col">
                    <span className="text-md font-black text-slate-900">{users.length}</span>
                  </div>
                </div>
                ...
                <NavLink to="/adminadddoctors" className="group grow sm:grow-0">
                  <div className="flex items-center gap-6 justify-between bg-white border border-slate-200 p-4 rounded-2xl shadow-sm hover:border-emerald-400 hover:shadow-md transition-all active:scale-95">
                    <div className="flex items-center gap-3">
                      <div className="flex items-center justify-center w-4 h-4 rounded-xl bg-emerald-50 text-emerald-600 group-hover:bg-emerald-600 group-hover:text-white transition-all">
                        <FaUserMd size={14} />
                      </div>
                      <div className="flex flex-col">
                        <span className="text-sm font-bold text-slate-800">Add New Doctor</span>
                      </div>
                    </div>
